...
// Qué es esto: simplemente los botones que aparecen en la barra de navegación
const links = [
  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto flex items-center justify-between rounded-full bg-cream/70 backdrop-blur-md border border-forest/10 px-5 md:px-7 py-3">
        ...
        {/* Logo — al pinchar vuelve arriba del todo */}
        ...
        {/* Menú de navegación — solo visible en pantallas medianas/grandes */}
        ...
        {/* Botón derecho — ahora va a Visítanos directamente, sin duplicar */}
